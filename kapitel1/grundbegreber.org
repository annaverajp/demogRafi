...
Demografi er studiet af befolkningers karakteristika og udvikling. 
Demografi beskæftiger sig således med emner som befolkningens størrelse,
befolkningsbevægelser samt aldersfordeling, kønsfordeling, etnicitet,
sprog, religion, uddannelse, erhverv og andre relevante karakteristika.
...
-mønstre. Demografi kan bidrage med vigtig information om befolkningens 
sundhedstilstand, uddannelsesbehov, arbejdsstyrke og økonomiske udvikling, 
som spiller en vigtig rolle i politiske beslutninger. Nogle af de områder, 
hvor demografi er relevant, inkluderer folkesundhed, økonomi, planlægning 
af byer og samfund, arbejdsmarked og socialpolitik. Metoderne, som vi bruger 
i demografi, er tæt beslægtet med metoder fra epidemiologi og statistik.
...
enhed på et bestemt tidspunkt. Dermed kan man tale om Danmarks
...
en befolkning som opfylder yderligere kriterier. For eksempel, danner
alle Kvinder, som modtager SU, er yngre end 25 år, og bor i Region
Sjælland den 1. januar 2023, en befolkninggruppe.

I demografi kan en befolkning beskrives og analyseres med statistikker
om befolkningsstørrelse, befolkningstæthed, aldersfordeling,
...
ofte til at forudsige og planlægge behovet for offentlige ydelser 
herunder tilrettelæggelse af sundhedsvæsnet, uddannelsesvæsenet eller
tiltag vedrørende beskæftigelse.
...
Hvis befolkningen ikke er genstand for ind- og udvandring, kaldes det
en lukket befolkning. Forekommer ind- og udvandring, er det en åben 
...
tid $t$, hvor $t$ er en given dato. Ifølge statistikbanken [fn:1] var
...
januar 2019 og den 1. januar 2023. Nedenfor er vist nogle linjer R-kode, 
som kan bruges til at beregne antallet af dage mellem to datoer og 
folketallets vækst i perioden.
...
hvert kvartal siden 2008 (FOLK1A), den 1. januar per år siden 1971
(BEFOLK1), den 1. januar per år siden 1901 (HISB3). Desuden er der
summariske tal fra folketællinger helt tilbage fra 1769 (FT). Disse tal
bliver vist i Figur ref:fig:1.
...
#+CAPTION: Udviklingen af den danske befolkning siden 1769. Summariske tal fra folketællinger, som findes i statistikbankens register FT.
[[file:./figure1.pdf]]
...
perioden i befolkningen.  Således kunne man beregne middelfolketallet
...
tidsperiode. Vi kan dog bruge en række metoder til at beregne
...
ændrer sig synderligt i den givne tidsperiode. For eksempel bruger
...
Alle tre metoder kan bruges ligeværdigt, hvis folketallet er
relativt stabilt i perioden.  Ændrer folketallet sig meget i perioden,
er metode 2 en bedre tilnærmelse til det sande ukendte
middelfolketal end metode 1, og ligeligt er metode 3
en bedre end metode 2. Figur ref:fig:2 visualiserer
...
Vi beregner middelfolketallet for den danske befolkning i en periode, som
...
januar 2023}] = 5.707.251\) personer. For at beregne metode 2
...
\(5722052.5\) personer. For metode 3 er beregningen i R den følgende:
...
i det her eksempel, at der er omkring 8.000 personer til forskel mellem
metode 3 og metode 2. Om denne forskel er vigtig eller ej, vil
afhænge af formålet med den konkrete demografiske undersøgelse. Er den
vigtig, vil man prøve at estimere middelfolketallet så godt som
muligt. For at gør det, vil man hente så mange folketal som muligt
fra perioden, og så beregne middelfolketallet med metode 3 på alle
disse tal. Følgende R-kode henter alle folketal mellem 1. januar 2009
...
fødsler, dødsfald og migration i en given periode i en befolkning. Jo flere
...
er folketal i slutningen højere jo flere personer bliver født og
...
- $I[t_1,t_2]$ er antallet af indvandringer i perioden
- $U[t_1,t_2]$ er antallet af udvandringer i perioden
...
Figur ref:fig:3 viser vækst, fødsler, dødsfald, ind- og udvandring
mellem 1980 og 2023 i den danske befolkning. Det er tydeligt, at
indvandring er den dominerende faktor for ændringer af folketal i
...
#+name: fig:3
#+ATTR_LATEX: :width 0.9\textwidth
#+CAPTION: Ændringinger i folketal (vækst), antal fødsler, dødsfald, ind- og udvandring siden 1980 .
[[file:./figure3.pdf]]
...
Baseret på disse tal beregner vi, at den danske befolknings vækst i
perioden er (5.932.654 - 5.873.420) = 59.234 personer. Den naturlige
...
som statistikbanken bogfører ikke er internt konsistente. Det kan der være
mange grunde til. En vigtig grund er, at det er svært at registrere de
præcise datoer for, hvornår ind- og udvandringer sker.
...
sammenligne absolutte antal døde i forskellige stor befolkninger. For
...
Bornholm end på Christiansø. Brugen af rater frem for absolutte antal er
...
dividerer man antallet af døde i en periode med antallet af personår,
som personer fra befolkningen har levet i samme periode. Mere generelt 
har en rate som kendetegn, at den er defineret som kvotient af to 
størrelser i forskelige måleenheder. Ved beskrivelse af en rates enheder 
bruges ordet ``per'' til at adskille enhederne for de to målinger, der bruges
...
en given periode, beregner man risikotiden eksakt som summen af alle
...
Denne formel kan anvendes rimlig generelt. Man skal dog være opmærksom
...
kapitel ser vi dog bort fra prædikatet ``summarisk'' og omtaler systematisk
summariske rater som rater.

*** Eksempel

Vi illustrerer beregningen af perioderater og bruger rater for flytninger 
inden for Danmarks grænser i perioden fra 1. januar 2020 til 1. januar 2023 som
...
Der er 2.773.056 flytninger i Danmark registreret i perioden
...
Flytningsraten for flytninger inden for Danmarks grænser var 157.2 flytninger 
per 1000 personår i perioden fra 1. januar 2020 til 1. januar 2023. Vi bemærker,
at vi har brugt folketal fra den 1. januar 2023 i stedet for folketal fra den 31.
december 2022. 
...
2022 til 1. januar 2023. Ud over samme data, som vi har brugt i eksemplet
